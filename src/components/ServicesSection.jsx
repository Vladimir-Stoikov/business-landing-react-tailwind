      ...
      <div className='flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-24'>
        ...
        <div className='md:w-1/2 w-full'>
          ...
          <div className='space-y-3'>
            <div className='flex gap-3 items-center'>
              <div className='w-5 h-5 rounded-full bg-indigo-100 flex justify-center items-center'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
          {services.map((service, index) => (
            <div key={index} className='max-w-72 bg-white cursor-pointer rounded-2xl p-6 hover:shadow-xl hover:scale-105 transition-all duration-300'>
